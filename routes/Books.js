  ...
  async (req, res) => {
    try {
     ...
     const result = await query(
      ...
      [req.body.title, req.body.author, req.body.subject, image_url , req.body.rack_Number]
    );
      ...
      if (!req.body.title || !req.body.author || !req.body.subject || !req.file || !req.rack_Number) {
